...
private AccountTransactionService accountTransactionService;
	...
	public void run(String... args) throws Exception {
		...
		/*Customer customer1=new Customer("nandu", "9780808766", "nandu@gmail.com", "bangolre") ;
		Account account1=new Account(1000.00, "SAVINGS", false);
		Customer customer2=new Customer("venky", "978080766", "venky@gmail.com", "vijayawada") ;
		...
		accountService.withdraw(1l, 289.00,"nandu");
		AppUser appUser1=new AppUser("meena", "meena@gmail.com", "meena", new String[]{"ROLE_ADMIN","ROLE_MGR","ROLE_CLERK"}, true, "357429789");
		AppUser appUser2=new AppUser("srinu", "srinu@gmail.com", "srinu", new String[]{"ROLE_CLERK"}, true, "7892935723");
